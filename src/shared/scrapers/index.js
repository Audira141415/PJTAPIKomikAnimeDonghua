 ...
 *
 * Usage:
 *   const { samehadaku, oploverz, anoboy, animekuindo, kusonime, animasu, animesail } = require('../shared/scrapers');
...
module.exports = { samehadaku, oploverz, anoboy, animekuindo, kusonime, animasu, animesail };
