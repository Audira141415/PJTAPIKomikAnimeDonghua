...
const ctrl = require('./mangasusuku.controller');

const router = Router();

router.get('/home',                      ctrl.home);
router.get('/home/:page',               ctrl.home);
...
router.get('/list-by-char/:char',       ctrl.byChar);
router.get('/list-by-char/:char/:page', ctrl.byChar);
