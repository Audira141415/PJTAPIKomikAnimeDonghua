...
const service = require('./mangasusuku.service');

const home    = catchAsync(async (req, res) => success(res, await service.home(req.params.page)));
...
const byChar  = catchAsync(async (req, res) =>
  success(res, await service.byChar(req.params.char, req.params.page)));
